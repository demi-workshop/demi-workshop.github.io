	...
	return (
		<>
			<section id="call-for-papers">
				...
				<p>
					We invite researchers, practitioners, and enthusiasts to submit
					original contributions aligned with the themes outlined on our&nbsp;
					<Link to="/workshop-details">workshop details page</Link>. Please
					review the submission guidelines and ensure your work adheres to the
					specified format and deadlines listed on the&nbsp;
				...
				<p style={{ marginBottom: 0 }}>
					We welcome your valuable contributions. Please follow the steps below
				...
				<p>
					Accepted papers will be published in a joint proceeding with the
				...
				<p>
					...
					&nbsp;. We recommend submission up to 8-pages and 2-pages of
					references (same as MICCAI main conference) for a double-blind peer
					review process In addition, since the joint workshop has adhered to
					the double-blinded peer review process, we ask that you please follow
					the &nbsp;
